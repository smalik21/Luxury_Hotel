...
const page = () => {
  ...
  return (
    ...
    {isHiddenDivVisible && (
                <div className='m-auto'>
                    <div onClick={toggleHiddenDiv} className='m-auto absolute w-[4rem] h-[4rem] mt-[7rem] ml-[11.5rem] md:w-[4rem] md:h-[4rem] bg-white rounded-full md:mt-[7rem] md:ml-[48rem] p-6 '><div className='h-[2rem] w-[2rem]'><RxCross2 /></div></div>
                <div className=' absolute h-[11rem] w-[23rem] mt-[14rem] ml-[2.5rem]  md:h-[13rem] md:w-[30rem] rounded-3xl bg-white md:ml-[35rem] md:mt-[15rem] border-2 border-black'>
                               <input type="text" id="input-group-1" className=" m-auto mt-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-[20rem] md:w-[25rem] ps-10 p-2.5 " placeholder="Enter your email"/>
                               <button type="button" className="mt-5 text-white w-[20rem] md:w-[25rem] ml-5 md:ml-10 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Continue</button>
    ...
    <div className= 'flex h-screen w-screen '>
        ...
        <div className='md:w-2/5 w-full  h-screen flex items-center justify-center mx-[2rem] '>
            <div>
                ...
                <div className='text-center text-3xl my-5 md:mr-[4rem]'>Sign In</div>
           <div className='mx-[5rem] md:mx-10'>
            ...
            <div className='text-gray-700 text-sm mb-2 ml-[12rem] md:ml-[12.8rem]'>Signin with</div>
            <button type="button" className="text-white w-[18rem] md:w-[25rem] ml-[5rem] md:ml-10 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Google</button>
          <Link href="/signup">  <div className='text-gray-700 text-sm mb-2 ml-[7rem] md:ml-[9rem]'>Don't have an account ? Sign Up</div></Link>
            </div>
        </div>
