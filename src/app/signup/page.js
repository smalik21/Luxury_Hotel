                        ...
                        <div>
                            ...
                            <div className='ml-[5rem] md:mx-10'>
                                <div className=" mb-4 justify-center items-center">
                                    ...
                                    <input onChange={handleChange} name="email" type="text" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-[18rem] md:w-[25rem] ps-10 p-2.5 " placeholder="Enter your email" />
                                </div>
                                <div className='flex '>
                                    <div className=" mb-4 mr-2">

                                        <input onChange={handleChange} name="firstName" type="text" id="input-group-1" className="ml-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-[8.5rem] md:w-[12rem]  p-2.5 " placeholder="First Name" />
                                    </div>
                                    <div className=" mb-4  mx-2">

                                        <input onChange={handleChange} name="lastName" type="text" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-[8.5rem] md:w-[12rem]  p-2.5 " placeholder="Last Name" />
                                    </div>
                                </div>
                            </div>
                            <div className="ml-[5rem] md:mx-10 mb-4">
                                <input onChange={handleChange} name="password" type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-[18rem] md:w-[25rem] p-2.5 " placeholder="Password" required />
                            </div>
                            <div className="ml-[5rem] md:mx-10 mb-4">
