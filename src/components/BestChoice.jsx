...
const BestChoice = () => {
  return (
    <div className="w-full">
      <div className="md:w-[928px] mx-auto my-10 bg-no-repeat bg-cover rounded-[60px]" style={{ backgroundImage: "url(./best-choice-image.png)" }} >
        <div className="flex flex-col gap-6 mt-10">
          <h1 className="font-[600] mt-10 text-[40px] text-center text-[#000000E5]">
            Discover the best choice for you
          </h1>

          <div className="mt-10 mb-10  mx-auto p-6 rounded-[30px] bg-white md:w-[800px]">
