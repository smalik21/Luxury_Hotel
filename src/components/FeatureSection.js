                ...
                <div className="space-y-8 md:-mr-14 md:ml-[70px] md:mt-14">
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 mb-[120px]">
                        ...
                        <div className="order-2 md:order-1 md:w-1/2">
                            <div className="max-w-md mx-auto md:mx-0">
                                <h3 className="text-xl text-[36px] font-semibold mb-2 text-black">Impressive experience</h3>
                                <p className="text-gray-600 text-[21px] max-w-[370px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 ">
                        ...
                        <div className="order-2 md:w-1/2">
                            <div className="max-w-md mx-auto md:mx-0">
                                <h3 className="text-xl text-[36px] font-semibold mb-2 text-black">Premium sport destination</h3>
                                <p className="text-gray-600 text-[21px] max-w-[370px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 mt-[120px]">
                        <div className="order-1 md:order-2 md:w-1/2">
                            <div className="h-48 bg-gradient-to-t to-gray-400 from-white mx-auto md:mx-0 rounded-md" style={{ maxWidth: '405.2px', maxHeight: '233px' }}></div>
                        </div>
                        <div className="order-2 md:order-1 md:w-1/2">
                            <div className="max-w-md mx-auto md:mx-0">
                                <h3 className="text-xl text-[36px] font-semibold mb-2 text-black">Big savings</h3>
                                <p className="text-gray-600 text-[21px] max-w-[370px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                    </div>
