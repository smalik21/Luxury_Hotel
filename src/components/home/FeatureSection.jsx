    ...
    return (
        <section className="py-20 max-w-screen overflow-hidden bg-white min-h-screen flex items-center justify-center">
            <div className="container mx-auto px-4 md:px-0 max-w-6xl justify-center">
                <div className="text-center md:mb-10 mb-14">
                    <h2 className="text-[30px] lg:text-[40px] text-black font-bold mb-4">Features we provide</h2>
                    <p className="text-gray-500 lg:text-[24px] md:text-[20px] text-[18px] text-center px-2 pb-8">Explore the unexplored, Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
                </div>
                <div className="space-y-8 md:-mr-14 md:ml-[70px] md:mt-14 ">
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 md:mb-[90px] mb-14">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 md:pb-[80px] pb-14 pt-4">
