                    ...
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 md:mb-[70px] mb-7">
                        ...
                        <div className="order-2 md:order-1 md:w-1/2 ">
                            <div className="lg:max-w-md max-w-[320px] text-center md:text-left mx-auto md:mx-0">
                                <h3 className="lg:text-[40px] mt-6 lg:mt-0 text-[26px] font-f_2 font-semibold mb-2 text-black">Unique life experiences</h3>
                                <p className="text-gray-600 lg:text-[18px] text-[15px] max-w-[370px] leading-tight">We specialize in offering once in a lifetime experiences that will create lasting memories.</p>
                            </div>
                        </div>
                    </div>
