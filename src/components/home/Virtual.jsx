...
const Virtual = () => {
  ...
  const Carddata = [
    ...
    {img:"./v3.jpg",heading:"Flight Reservations",time:"30 mins",info:"We Assist you in planning your flights from anywhere around the globe. Help you get the best costs and recommend dates and times for your travel incase you are not certain about your plans."},
  ...
  return (
    <div className="py-10 md:py-20 bg-white min-h-screen flex items-center justify-center">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        <h1 className="text-black text-3xl md:text-4xl font-bold text-center mb-10">Connect with our Virtual Assistants at any time of your convenience!</h1>
