        ...
        <div className="flex flex-col gap-6 mt-5 sm:mt-10">
          ...
          <div className="sm:mt-5 sm:mb-10  mx-auto p-5 rounded-md md:rounded-[30px] bg-white w-full md:w-[1000px] shadow-lg">
            ...
            <div className="grid grid-cols-1  md:grid-cols-2 gap-5 mt-10">
              {[
                { title: "Goa Hotels", location: "190 hotels at Goa, India", image: "./y1.png" },
                { title: "Pune Hotels", location: "120 hotels at Pune, India", image: "./y2.png" },
                { title: "Delhi Hotels", location: "90 hotels at Delhi, India", image: "./y3.png" },
                { title: "Lonavala Hotels", location: "50 hotels at Lonavala, India", image: "./y4.png" },
                { title: "Capri, Italy Hotels", location: "110 hotels a tCapri, Italy", image: "./y5.png" },
                { title: "Paris Hotels", location: "20 hotels at Paris, France", image: "./y6.png" },
              ].map((hotel, index) => (
